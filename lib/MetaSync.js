  ...
  class MetaSync extends S.classes.Plugin {
    ...
    registerActions() {
      ...
      S.addAction(this.metaSync.bind(this), {
        handler:       'metaSync',
        description:   'This command allows you to share your Serverless project\'s meta files via S3 bucket',
        context:       'meta',
        contextAction: 'sync',
        options:       [
          {
    ...
    getKey() {
      return this.config.keyPrefix + this.syncFileName;
    }
    ...
    _validateAndPrepare() {
      ...
      _.defaults(this.config, {keyPrefix: `serverless/${proj.getName()}/variables/`});
    ...
    _diff() {
      ...
      const choices = [
        ...
        {
          value: "remote",
          label: "Apply these changes to the local version"
        },
        {
          value: "local",
      ...
      return this.cliPromptSelect("How should these differences be handled?", choices, false)
